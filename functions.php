...
add_action('wp_enqueue_scripts', 'rightnowplumbing_scripts', 100);
function rightnowplumbing_scripts(){
  wp_register_script(
    'bootstrap-script', 
...
function rightnowplumbing_styles(){
  wp_register_style('bootstrap-css', '//maxcdn.bootstrapcdn.com/bootstrap/3.3.7/css/bootstrap.min.css');
  wp_register_style('rightnowplumbing', get_template_directory_uri() . '/style.css');
  
  wp_enqueue_style('bootstrap-css');
  wp_enqueue_style('rightnowplumbing');
}
